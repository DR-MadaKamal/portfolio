export const personalData = {
  ...
  heroSummary: `I am a dynamic professional bridging the gap between clinical healthcare and full-stack digital marketing. With a meticulous foundation in pharmacy management and advanced expertise in creative direction, I help B2B and B2C brands scale their reach and drive sustainable customer acquisition.
...
💡 Core Expertise: • Full-Stack Digital Marketing & SEO • Brand Strategy & Identity • Motion Graphics & Video Editing (Adobe After Effects, Premiere Pro) • UI/Web Development & AI Integration • Pharmacy Operations & Healthcare Compliance
...
export const experience = [
  ...
  },
  {
    ...
    media: [
      ...
      { title: 'MAJAL', description: 'Brand design assets and seasonal campaign creatives.', image: '/portfolio/images/logos/Majal Logo.jpg' },
      { title: 'Eagle Eye (إي إيجيل)', description: 'Visual identity + social media content design.', image: '/portfolio/images/logos/Eagle Eye logo.png' },
      { title: 'Ghareeb Dentist', description: 'Clinic branding and patient-focused marketing creatives.', image: '/portfolio/images/logos/Ghareeb Dentist logo.png' },
      { title: 'MR Belal (الدينامو)', description: 'Personal brand creatives and social content.', image: '/portfolio/images/logos/MR Belal logo.jpg' },
      { title: 'Kazoza Mix', description: 'Brand identity and social media content.', image: '/portfolio/images/logos/kazoza mix logo.jpg' },
  ...
  },
  {
    ...
    company: 'Al-Tayeb Trading & Supplies',
    period: '07/2023 – 08/2024',
    location: 'Al-Faiyum',
    logo: '/portfolio/images/logos/al-tayeb logo.png',
    highlights: [
      'Led digital campaigns for the parent company and its major brand Instires, driving engagement.',
...
export const skillCategories = [
  {
    ...
    icon: 'fa-stethoscope',
    skills: [
      'Pharmacy Operations & Inventory Control',
      'Team Leadership',
      'Pharmaceutical Knowledge',
      'HCPs Targeting',
      'Medical Content Creation & Copywriting',
      'Omnichannel Marketing Strategy',
      'Product Launch & Lifecycle Management',
      'Market Research & Competitor Analysis',
      'Clinical Data Interpretation',
      'Rx & OTC Product Knowledge',
  ...
  },
  {
    ...
    skills: [
      ...
      'Video Editing',
      'UI/Web Development',
      'AI Image Generation & Refinement',
    ],
  },
  {
    ...
    skills: [
      ...
      'CRM Management & Customer Acquisition',
