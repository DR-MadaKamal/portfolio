export const personalData = {
  ...
  title: 'Pharmacist | Medical Marketing Professional | Full-Stack Marketer | Brand Growth Architect',
  phone: '+201009852109',
  email: '16491@must.edu.eg',
  location: 'Cairo / Al-Faiyum, Egypt',
  ...
  summary: `Results-driven Pharmacy graduate and Medical Marketing Professional with extensive experience in pharmaceutical operations, B2B/B2C sales management, HCP engagement, and KOL management. Demonstrated success in product launch execution, territory management, and omnichannel clinical campaigns for healthcare providers, with deep knowledge of therapeutic areas including dermatology, cardiovascular, and general medicine, and strict adherence to pharma compliance and regulatory requirements. Highly adept at bridging clinical knowledge with advanced digital marketing, CRM, and brand strategies to drive product visibility, engage Healthcare Professionals (HCPs), and maximize ROI by up to 35% in competitive markets. Proven track record of building brands from scratch, managing full-stack marketing operations, and leading cross-functional teams across Egypt, UAE, and KSA markets.`,
  heroSummary: `Results-driven Pharmacy graduate and Medical Marketing Professional with extensive experience in pharmaceutical operations, B2B/B2C sales management, HCP engagement, and KOL management.

As the Founder and Lead Creative Director at Mada Kamal, I specialize in premium brand strategy, high-end motion graphics, and AI-driven workflows. My approach combines clinical knowledge with innovative design to build scalable marketing campaigns, manage high-performing teams, and optimize budgets for maximum ROI.

💡 Core Expertise: • Medical Marketing & HCP Engagement • KOL Management & Product Launch • Full-Stack Digital Marketing & SEO • Brand Strategy & Identity • Motion Graphics & Video Editing (Adobe After Effects, Premiere Pro) • Pharmacy Operations & Healthcare Compliance • CRM & Marketing Automation

I am always open to connecting with industry professionals, agency partners, and forward-thinking brands looking to elevate their digital presence and drive sustainable growth.`,
  medicalFocus: [
    'Medical representative & medical marketing focus',
    'HCP targeting & segmentation (specialties, clinics, pharmacies)',
    'KOL management and engagement strategy',
    ...
    'Therapeutic areas: dermatology, cardiovascular, general medicine',
  ],
  available: true,
  whatsapp: '201009852109',
  cvUrl: '/portfolio/Mohammed_Kamal_Shaat_Final.pdf',
}

export const experience = [
  {
    role: 'Full-Stack Marketing Manager',
    company: 'FLAVOW (Vape City & Vapsy Brands)',
    period: '05/2024 – Present',
    location: 'Abbasiya, Cairo, Egypt',
    logo: '/portfolio/images/logos/flavow-logo.png',
    highlights: [
      'Architected the full brand identity of FLAVOW from inception, including logo design, brand guidelines, and visual identity system adopted across all sub-brands.',
      'Managed full-stack marketing operations for two consumer product brands (Vape City & Vapsy), acting simultaneously as Creative Director, Media Buyer, and Social Media Manager.',
      'Built and launched the company\'s e-commerce platform and product catalogs from scratch, increasing B2C online engagement by over 40%.',
      'Developed and implemented a complete CRM system, sales pipeline, and inventory management system in collaboration with the operations team.',
      'Planned and executed brand events, coordinating logistics, creative production, and on-ground activation.',
      'Managed strategic advertising budgets across Meta and Google Ads, implementing A/B testing frameworks that maximized ROI by 35% and reduced cost-per-acquisition (CPA).',
      'Leveraged Google Analytics (GA4) and Meta Ads Manager to track campaign KPIs and deliver data-driven performance reports to leadership.',
      'Key Brands & Projects: FLAVOW (Parent Brand), Vape City, Vapsy, Flavow Store, Mr-Vape.',
    ],
    links: [
      { label: 'flavow-store.com', url: 'https://www.flavow-store.com' },
    ],
    media: [
      { title: 'Vape City', description: 'E-commerce catalog + product content + brand marketing assets for the e-liquid line.', image: '/portfolio/images/vape-city/vapsy logo.png' },
    ],
  },
  {
    role: 'Founder & Lead Creative Director',
    company: 'Mada Kamal Creative Agency',
    period: '01/2022 – Present',
    location: 'Remote / Freelance',
    logo: '/portfolio/images/adonis/breathe logo - white.png',
    highlights: [
      'Founded and manage a full-service creative agency delivering branding, motion graphics, social media management, paid advertising, and full-stack marketing solutions for 20+ B2B and B2C clients across Egypt, UAE, and KSA.',
      'Bluecastle Caffee (UAE, Abu Dhabi): Delivered complete brand identity including logo, menus, and all visual assets; built and managed all social media profiles; ran Meta and Google Ads campaigns remotely; created and managed brand events; set up Google Maps and Waze business listings.',
      "Adoni's Clinics & Breath Beauty Centers: Delivered full graphic design and branding solutions for both entities under the same parent company — Adoni's targeting mid-market clients and Breath targeting the high-end segment — ensuring distinct visual identities aligned with each brand's positioning.",
      'Eagle Eye & Ghareeb Dentist: Managed comprehensive full-stack marketing including branding, graphic design, social media management, paid advertising on Meta and Google, motion graphics, and content production (no website).',
      'Kazoza Mix: Managed all marketing operations from brand launch through the first 6 months post-launch, covering branding, social media, ads, content creation, and performance tracking — delivering a complete go-to-market strategy.',
      'Klüger: Delivered branding, graphic design, social media management, and paid advertising campaigns.',
      'MAJAL: Produced professional motion graphics content for brand communications.',
      "Elon's, Green Planet, B Way Agency, MR Belal (El-Dynamo): Delivered graphic design, creative direction, and full branding packages.",
      'Executed product launch messaging and UI/UX conversion improvements, achieving a 25% average increase in user conversion rates through A/B testing and audience segmentation.',
      'Collaborated with medical and healthcare clients on clinical campaign development and HCP-facing promotional materials aligned with pharma compliance standards.',
      'Key Clients: Bluecastle Caffee (UAE), Adoni\'s Clinics, Breath Beauty Centers, Ghareeb Dentist, Eagle Eye, Kazoza Mix, Klüger, Elon\'s, Green Planet, B Way Agency, MAJAL, MR Belal, H&M Perfume\'s Store (KSA), Samir Tito Barber, Toy\'s Station Nursery, Avalance Auto Repair (UAE).',
    ],
    media: [
      { title: 'Bluecastle Caffee (UAE)', description: 'Complete brand identity, social profiles, Meta/Google Ads, events, Google Maps/Waze listings.', image: '/portfolio/images/bluecastle/white no bg.png' },
      { title: "Adoni's Clinics", description: 'Full graphic design and branding for mid-market healthcare brand.', image: '/portfolio/images/logos/Adonis logo.png' },
      { title: 'Breath Beauty Centers', description: 'High-end segment branding and visual identity.', image: '/portfolio/images/logos/breathe logo - white.png' },
      { title: 'Eagle Eye', description: 'Full-stack marketing: branding, social media, paid ads, motion graphics.', image: '/portfolio/images/logos/Eagle Eye logo.png' },
      { title: 'Ghareeb Dentist', description: 'Clinic branding, social media management, paid ads, content production.', image: '/portfolio/images/logos/Ghareeb Dentist logo.png' },
      { title: 'Kazoza Mix', description: 'Complete go-to-market strategy: brand launch through first 6 months.', image: '/portfolio/images/logos/kazoza mix logo.jpg' },
      { title: 'Klüger', description: 'Branding, graphic design, social media management, paid advertising.', image: '/portfolio/images/logos/kluger logo.jpg' },
      { title: 'MAJAL', description: 'Professional motion graphics content for brand communications.', image: '/portfolio/images/logos/Majal Logo.jpg' },
      { title: "Elon's", description: 'Graphic design, creative direction, full branding package.', image: '/portfolio/images/logos/Elons logo.jpg' },
      { title: 'Green Planet', description: 'Graphic design, creative direction, full branding package.', image: '/portfolio/images/logos/GP logo.png' },
      { title: 'B Way Agency', description: 'Graphic design, creative direction, full branding package.', image: '/portfolio/images/logos/b way logo.png' },
      { title: 'MR Belal (El-Dynamo)', description: 'Graphic design, creative direction, full branding package.', image: '/portfolio/images/logos/MR Belal logo.jpg' },
      { title: 'Mlabs-Shabab', description: 'Brand identity and campaign creatives.', image: '/portfolio/images/logos/Mlabs Shabab logo.png' },
  ...
  {
    role: 'Marketing Manager & Motion Graphics Editor',
    company: 'Trade Point',
    period: '01/2022 – Present',
    location: 'Al-Faiyum, Egypt',
    logo: '/portfolio/images/logos/Trade point logo.jpg',
    highlights: [
      'Managed all social media channels, paid advertising campaigns (Meta & Google), and motion graphics & video editing production for Trade Point and its client portfolio.',
      'Contributed to business development initiatives, helping identify and secure key accounts including Instires and Al-Tayeb Trading, which were subsequently scaled into major contracts.',
      'Directed and managed sales and call center teams, streamlining customer acquisition workflows and improving client retention rates by 18%.',
      'Ensured cohesive cross-platform messaging and produced polished multimedia content to differentiate the brand in a saturated market.',
      'Delivered detailed visual performance reports and market share analysis to internal stakeholders to support data-driven strategy decisions.',
      'Key Clients & Projects: TradePoint, Majal, Nice Ads Agency, Instires, Al-Tayeb, Click & Set.',
    ],
    links: [
    ...
    media: [
      { title: 'TradePoint', description: 'Motion graphics, promotional videos, and social content used across Trade Point campaigns.', image: '/portfolio/images/tradepoint/photo_2021-09-23_17-38-29.jpg' },
    ],
  },
  {
    role: 'Digital Marketing Manager',
    company: 'Al-Tayeb Trading & Supplies (Instires)',
    period: '07/2023 – 08/2024',
    location: 'Al-Faiyum, Egypt',
    logo: '/portfolio/images/logos/al-tayeb logo.png',
    highlights: [
      'Served as full Digital Marketing Manager for Al-Tayeb and its flagship brand Instires, overseeing all marketing, sales, and customer operations.',
      'Managed all social media channels and executed end-to-end paid advertising campaigns across Meta and Google, driving a 50% increase in social media engagement.',
      'Spearheaded the pre-launch campaign, generating over 5,000+ qualified leads prior to product launch through targeted digital campaigns and influencer activations.',
      'Managed KOL engagement strategy with 15+ Key Opinion Leaders, significantly expanding brand reach and penetrating new market segments.',
      'Oversaw CRM management, customer support operations, and call center team to ensure high satisfaction and repeat purchase rates.',
      'Led website development and ongoing management, ensuring optimal UX and conversion performance.',
      'Increased overall sales and ROI through performance marketing optimization and data-driven budget allocation.',
      'Key Brands & Projects: Instires, Al-Tayeb.',
    ],
    links: [
      { label: 'Instires (انستايرز)', url: '#' },
    ],
    media: [
      { title: 'Instires (انستايرز)', description: 'Campaign videos + brand visuals supporting social growth and product promotion.', image: '/portfolio/images/logos/instires logo.png' },
    ],
  },
  {
    role: 'Marketing Manager',
    company: 'Aldoha Engineering',
    period: '06/2018 – 07/2023',
    logo: '/portfolio/images/logos/Al-Doha Engineering logo.jpg',
    location: '6th of October City & Al-Faiyum, Egypt',
    highlights: [
      'Led all marketing operations over 5 years including social media management, paid advertising (Meta & Google), motion graphics production, and customer relationship management.',
      'Established a strong regional footprint across Al-Faiyum and 6th of October City, increasing qualified leads by 45% across the assigned territory.',
      'Managed CRM systems to track customer interactions, streamline follow-ups, and improve conversion rates throughout the sales funnel.',
      'Optimized digital advertising budgets and delivered detailed visual performance reports, reducing cost-per-acquisition (CPA) by 20% for internal stakeholders.',
      'Conducted market share analysis and competitive intelligence reporting to refine brand positioning and capture new accounts.',
      'Key Clients & Projects: Aldoha Engineering, Summit View Real Estate, The Groove Strip Mall.',
    ],
  },
  {
    role: 'Medical Representative (Trainee)',
    company: 'LILLY Pharmaceuticals for Distributions',
    period: '2014 – 2015',
    location: 'Al-Faiyum, Egypt',
    highlights: [
      'Trained under Dr. Mohamed Osama Haroun (Pharmacist & Founder) in a specialized pharmaceutical distribution company focused on dermatology and skincare therapeutic products across the Al-Faiyum governorate.',
      'Conducted field detailing and product presentations to dermatologists, general practitioners, and pharmacy staff, promoting a portfolio of skincare and dermatological pharmaceutical products.',
      'Developed core competencies in HCP communication, medical detailing techniques, objection handling, and closing pharmaceutical sales deals.',
      'Managed territory coverage across Al-Faiyum, ensuring consistent HCP visits, relationship building, and account follow-up to secure and grow sales.',
      'Gained hands-on exposure to pharma compliance standards, promotional material guidelines, and prescription-driven sales cycles within the dermatology therapeutic area.',
      'Supported prescription data tracking and compiled field intelligence reports to assist in territory management and account prioritization.',
    ],
  },
  {
    role: 'Pharmacy Operations Supervisor',
    company: 'Dr. Hamada Hamdi El-Gendy Pharmacy',
    period: '04/2015 – 11/2018',
    location: 'Abswai, Al-Faiyum, Egypt',
    highlights: [
      'Managed all daily pharmacy operations including dispensing, procurement, inventory control, and staff supervision, growing the single-branch pharmacy into a multi-branch pharmacy group.',
      'Spearheaded expansion strategy by developing supplier relationships and scaling procurement operations to support the transition from a single pharmacy to a network of multiple branches.',
      'Managed OTC medications, cosmetic and skincare product lines, ensuring optimal shelf availability, visual merchandising, and patient recommendations.',
      'Utilized prescription data analysis and sales-trend monitoring to maintain 95% inventory accuracy, prevent stockouts, and increase overall profitability by 15%.',
      'Provided expert patient counseling on Rx and OTC medications to 80+ patients daily across multiple therapeutic areas, ensuring optimal therapeutic outcomes and excellent customer retention.',
      'Ensured strict pharmaceutical regulatory compliance with all dispensing, documentation, and storage standards.',
      'Trained and mentored junior pharmacists and assistants on clinical protocols, dispensing procedures, and compliance requirements.',
    ],
  },
  {
    role: 'Pharmacy Trainee (Senior & Junior)',
    company: 'Dr. Khalid Sayd Pharmacy & Dr. Rasha Said Pharmacy',
    period: '04/2013 – 04/2015',
    location: 'Al-Faiyum, Egypt',
    highlights: [
      'Acquired comprehensive foundational training in pharmaceutical dispensing, OTC drug counseling, and prescription handling under direct supervision of licensed pharmacists.',
      'Learned and applied professional shelf organization systems (planograms) and inventory stocking protocols to ensure efficient pharmacy operations.',
      'Handled patient-facing sales and counseling for OTC medications, cosmetics, and skincare products, developing strong communication and customer service skills.',
      'Managed supplier ordering processes and stock replenishment cycles, gaining hands-on experience in pharmaceutical procurement and supply chain operations.',
      'Developed professional conduct and HCP interaction standards essential for patient safety and regulatory compliance in a pharmacy setting.',
    ],
  },
]
...
export const education = [
  {
    ...
    school: 'MUST (Misr University For Science And Technology)',
    year: '09/2005 – 06/2026',
    location: 'Al-Faiyum, Egypt',
    coursework: ['Medicinal Chemistry', 'Pharmacology', 'Nephron Histology', 'Clinical Pharmacy'],
  },
]

export const skillCategories = [
  {
    category: 'Medical Sales & Marketing',
    icon: 'fa-stethoscope',
    skills: [
      'Medical Marketing',
      'HCP Engagement',
  ...
  {
    category: 'Pharmacy & Clinical Knowledge',
    icon: 'fa-prescription-bottle-alt',
    skills: [
      'Pharmacology',
      'Patient Counseling',
      'Therapeutic Areas (Dermatology, Cardiovascular, General Medicine)',
      'OTC & Rx Drug Management',
...
export const courses = [
  { name: 'Full Stack Digital Marketing & Analytics Path', provider: 'Google Learning', year: '2023' },
  { name: "Graphic's Design and Social Media Ads", provider: 'LinkedIn Learning', year: '2023' },
  { name: 'Nano Degree | Advanced Digital Marketing', provider: 'Udacity & MCIT', year: '2021' },
  { name: 'Graphic Design Careers: First Steps', provider: 'LinkedIn', year: '04/2021' },
  { name: 'Advanced Degree | Digital Marketing', provider: 'HP Development Company', year: '2021' },
...
export const awards = [
  { title: 'Top Performer in Digital Marketing', issuer: 'Google Learning', year: '2023', icon: 'fa-trophy' },
  { title: 'Advanced Digital Marketing Excellence', issuer: 'Udacity & MCIT', year: '2021', icon: 'fa-certificate' },
  { title: 'Customer Relationship Management (CRM)', issuer: 'HP LIFE', year: '2025', icon: 'fa-certificate' },
  { title: 'The Art of Sales: Fundamentals of Selling', issuer: 'HP LIFE', year: '2025', icon: 'fa-award' },
  { title: 'Social Media Marketing Foundations', issuer: 'LinkedIn', year: '2022', icon: 'fa-certificate' },
  { title: 'Skills for Passing Personal Interviews', issuer: 'Misr University for Science and Technology', year: '2025', icon: 'fa-user-graduate' },
]
...
export const clientLogos = [
  { src: '/portfolio/images/logos/Vape City.png', link: '', name: 'Vape City' },
  { src: '/portfolio/images/logos/Trade point logo.jpg', link: '', name: 'Trade Point Egypt' },
  { src: '/portfolio/images/logos/flavow-logo.png', link: '', name: 'Flavow Store' },
  { src: '/portfolio/images/logos/Mada Kamal Agency.png', link: '', name: 'Mada Kamal Agency' },
  { src: '/portfolio/images/logos/347029559_271030172008871_3862549720575985620_n.jpg', link: '', name: 'Swell Lake' },
  { src: '/portfolio/images/logos/BlueCastle Caffee.png', link: '', name: 'Bluecastle Caffee' },
  { src: '/portfolio/images/logos/305633335_457890299716313_2478224452526733934_n.jpg', link: '', name: 'Klüger' },
  { src: '/portfolio/images/logos/263380167_5173855415961443_6431828736852671287_n.jpg', link: '', name: 'MAJAL' },
  { src: '/portfolio/images/logos/244676964_1240855479671550_5981509515233517187_n.png', link: '', name: 'Eagle Eye' },
  { src: '/portfolio/images/logos/Ghareeb Dentist logo.png', link: '', name: 'Ghareeb Dental' },
  { src: '/portfolio/images/logos/MGD company logo.jpg', link: '', name: 'MGD' },
  { src: '/portfolio/images/logos/310385000_108501575368547_2424709495730499217_n.jpg', link: '', name: '310385000' },
  { src: '/portfolio/images/logos/Adonis logo.png', link: '', name: 'Adonis' },
  { src: '/portfolio/images/logos/Ahmed Samy Logo - Final-01.png', link: '', name: 'Ahmed Samy' },
  { src: '/portfolio/images/logos/Al-Doha Engineering logo.jpg', link: '', name: 'Al-Doha Engineering' },
  { src: '/portfolio/images/logos/al-tayeb logo.png', link: '', name: 'Al-Tayeb' },
  { src: '/portfolio/images/logos/Arch House Logo.png', link: '', name: 'Arch House' },
  { src: '/portfolio/images/logos/b way logo.png', link: '', name: 'B Way Agency' },
  { src: '/portfolio/images/logos/Buzy Daisy Logo.jpg', link: '', name: 'Buzy Daisy' },
  { src: '/portfolio/images/logos/Elons logo.jpg', link: '', name: 'Elons' },
  { src: '/portfolio/images/logos/GP logo.png', link: '', name: 'Green Planet' },
  { src: '/portfolio/images/logos/instires logo.png', link: '', name: 'Instires' },
  { src: '/portfolio/images/logos/kazoza mix logo.jpg', link: '', name: 'Kazoza Mix' },
  { src: '/portfolio/images/logos/logo_4.png', link: '', name: 'Logo 4' },
  { src: '/portfolio/images/logos/347879829_293786866330729_4448696274287037175_n.png', link: '', name: 'Mlabs Shabab' },
  { src: '/portfolio/images/logos/MR Belal logo.jpg', link: '', name: 'Mr Belal' },
  { src: '/portfolio/images/logos/300285902_456445189829190_7594357484335375349_n.jpg', link: '', name: 'Nice Ads Agency' },
  { src: '/portfolio/images/logos/vapsy-logo.png', link: '', name: 'Vapsy' },
  { src: '/portfolio/images/logos/\u0644\u0648\u062C\u0648 \u0627\u0644\u0632\u0639\u064A\u0645 2.png', link: '', name: 'Al-Zaeem' },
  { src: '/portfolio/images/logos/\u0644\u0648\u062C\u0648 \u062D\u0632\u0628 \u0645\u0633\u062A\u0642\u0628\u0644 \u0648\u0637\u0646.png', link: '', name: 'Mostaqbal Watan' },
  { src: '/portfolio/images/logos/breathe logo - white.png', link: '', name: 'Breathe' },
  { src: '/portfolio/images/logos/tito style barber .png', link: '', name: 'Tito Style Barber' },
]
